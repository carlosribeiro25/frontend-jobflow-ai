...
export function WhatsappConnect() {
  ...
  } = useGroups(activeConnectId ?? 0, isReady && !!activeConnectId)
          ...
          <Card key={conn.id}>
            <CardContent className="space-y-4 p-5">
              ...
              <div className="flex gap-1 mt-2 py-2">
                ...
                <Button variant="destructive" onClick={() => disconnect.mutate(conn.id)}>
                  {' '}
                  Desconectar
                </Button>
              </div>
        ...
        {isReady && groupsError && (
          <Card>
            <CardContent>
              ...
              <Button variant="destructive" onClick={() => refetchGroups()}>
                Tentar novamente
              </Button>
            </CardContent>
          </Card>
        ...
        {isReady && groups && (
          <Card className="">
            ...
            <CardContent className="w-full flex flex-col">
              ...
              <Button type="submit" onClick={() => selectGroups.mutate(selectedGroupIds)}>
                Salvar seleção
              </Button>
            </CardContent>
          </Card>
