...
export function RegisterUser() {
  ...
  const mutation = useMutation({
    ...
    onError: (error: unknown) => {
      const apiError =
        error instanceof AxiosError ? (error as AxiosError<RegisterErrorResponse>) : null
      ...
      if (apiError?.response?.status === 400) {
        ...
        addToast({
          ...
          message: getErrorMessage(
            ...
            'Este email ja esta cadastrado, tente com outro email.'
          ),
          duration: 4000,
        })
      } else {
    ...
    <div className="md:w-sm overflow-hidden p-10 md:p-12 lg:w-md justify-center m-auto min-h-screen  items-center">
      ...
      <Card>
        ...
        <CardContent>
            ...
            <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className=" absolute right-2 mt-2 text-gray-400 "
                ...
                <div className="relative">
                  <Label className="py-1" htmlFor="confirmPassword">
                    Confirmar senha
                  </Label>
                  <Input
          ...
          <Link className="text-blue-300 justify-center flex mt-2" to="/login">
            Voltar
          </Link>
        </CardContent>
      </Card>
